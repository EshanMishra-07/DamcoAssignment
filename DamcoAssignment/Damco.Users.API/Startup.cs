...
namespace Damco.Users.API
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<DamcoPocContext>(options => options.UseSqlServer(
       ...
       b => b.MigrationsAssembly(typeof(DamcoPocContext).Assembly.FullName)));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Damco.Users.API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Damco.Users.API v1"));
            }
